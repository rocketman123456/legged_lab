...
class NeptuneSummaryWriter(SummaryWriter):
    ...
    def __init__(self, log_dir: str, flush_secs: int, cfg):
        ...
        try:
            ...
            raise KeyError("Neptune api token not found. Please run or add to ~/.bashrc: export NEPTUNE_API_TOKEN=YOUR_API_TOKEN")

        try:
            entity = os.environ["NEPTUNE_USERNAME"]
        except KeyError:
            raise KeyError("Neptune username not found. Please run or add to ~/.bashrc: export NEPTUNE_USERNAME=YOUR_USERNAME")
